...
module.exports = {
    ...
    SESSION: process.env.BAKI_CODE === undefined ? '' : process.env.BAKI_CODE,
    ...
    GITMSG: process.env.GIT_MESSAGE === undefined ? 'official Baki' : process.env.GIT_MESSAGE,
    AFN: process.env.ALL_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ Baki*' : process.env.ALL_CAPTION,
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Bᴀki' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ Baki*' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/KUaX2XT.jpeg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Baki' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '27634923280@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'official baki' : process.env.BOT_NAME,
    KAZTRO_SER: process.env.ALIVE_BUTTON === undefined ? 'saᴅ/ʜᴀᴘᴘʏ' : process.env.ALIVE_BUTTON,   
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'Baki' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'baki/💙/🌟/🥀/🐾' : process.env.CMD_LIST,
    ...
    YAK: process.env.YAK === undefined ? '27634923280,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUDO: process.env.SUDO === undefined ? '27634923280,0' : process.env.SUDO,
    DEBUG: DEBUG,

...
module.exports = {
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Tshephang' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ ᴋᴀᴢᴛʀᴏsᴇʀ*' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/OR6yFkO.jpeg' : process.env.LG_LOGO,

...
module.exports = {
    ...
    SESSION: process.env.BAKI_CODE === undefined ? '' : process.env.KAZTROSER_CODE,
    ...
    GITMSG: process.env.GIT_MESSAGE === undefined ? 'Baki' : process.env.GIT_MESSAGE,
    AFN: process.env.ALL_CAPTION === undefined ? '*made by Baki*' : process.env.ALL_CAPTION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? '*Made by Baki*' : process.env.ALL_CAPTION,
    ...
    CODE: process.env.C_CODE === undefined ? '27' : process.env.C_CODE,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'Baki-Hanma' : process.env.BOT_NAME,
    ...
    SONGD: process.env.SONGD === undefined ? 'wait ' : process.env.SONGD,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'baku/💙/🌟/🥀/🐾' : process.env.CMD_LIST,
